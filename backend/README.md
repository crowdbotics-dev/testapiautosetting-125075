...
## Project Structure
    ...
    ├── testapiautosetting_125075  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125075`
...
2. Clone this repo and `cd testapiautosetting_125075`
